...
import 'package:documentsuploader/ui/items/music_viewer.dart';
import 'package:documentsuploader/ui/items/pdf_viewer.dart';
import 'package:documentsuploader/ui/items/video_viewer.dart';
...
Widget buildMusicFile(String title, String link) => Column(
      children: [
        ListTile(
            trailing: InkWell(
                onTap: () {
...
Widget buildvideoFile(String title, String link) => Column(
      children: [
        ListTile(
            trailing: InkWell(
                onTap: () {
